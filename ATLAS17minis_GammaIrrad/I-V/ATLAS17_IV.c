...
void TempScale(TString file, double temp, TString rad){
  ...
  ofstream outfile;
  infile.open(file);
  outfile.open("Pre_Anneal/ATLAS17_"+rad+"_IV_scaled.txt");
  while(!infile.eof())
    {
...
void ATLAS17_IV(){
  ...
  if(input == "y"){
    ...
    Pre_10Mrad = "Pre_Anneal/ATLAS17_10Mrad_PreAnneal_IV_scaled.txt";
    Pre_17p5Mrad = "Pre_Anneal/ATLAS17_17p5Mrad_PreAnneal_IV_scaled.txt";
    Pre_35Mrad = "Pre_Anneal/ATLAS17_35Mrad_PreAnneal_IV_scaled.txt";
